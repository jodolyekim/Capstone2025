...
def get_candidates(request):
    ...
    for candidate in candidates:
        ...
        # ✅ 수정됨: 다중 사진 조회
        photos = ProfilePhoto.objects.filter(profile=candidate)
        photo_urls = [request.build_absolute_uri(p.image.url) for p in photos]

...
from .models import Interest, InterestKeywordCategoryMap, InterestCategory
...
class InterestSerializer(serializers.ModelSerializer):
    class Meta:
        model = Interest
        fields = ['id', 'keyword', 'source']

class InterestCategoryMapSerializer(serializers.ModelSerializer):
    interest = InterestSerializer()
    category = serializers.StringRelatedField()

    class Meta:
        model = InterestKeywordCategoryMap
        fields = ['interest', 'category']
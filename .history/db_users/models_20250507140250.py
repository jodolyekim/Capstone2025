...
from users.models import CustomUser  # ← 핵심 변경

class Profile(models.Model):
    user = models.OneToOneField(CustomUser, on_delete=models.CASCADE, related_name='db_users_profile')
...
class Guardian(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='db_users_guardians')
    name = models.CharField(max_length=50)
...
class Photo(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='db_users_photos')
...
class Interest(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='db_users_interests')
...
class Match(models.Model):
    user1 = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='db_users_matches_as_user1')
    user2 = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='db_users_matches_as_user2')
...
class Message(models.Model):
    ...
    sender = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='db_users_sent_messages')
...
class BadWordsLog(models.Model):
    user = models.ForeignKey(CustomUser, on_delete=models.CASCADE, related_name='db_users_badwords_logs')

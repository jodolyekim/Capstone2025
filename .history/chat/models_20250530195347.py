...
from matching.models import Match  # ✅ 이거 꼭 추가해줘야 함
...
class ChatRoom(models.Model):
    ...
    match = models.OneToOneField(Match, on_delete=models.CASCADE, related_name='chatroom', null=True, blank=True)  # ✅ 추가됨

...
def get_candidates(request):
    ...
    my_orientation = profile.preferred_gender
    ...
    for candidate in candidates:
        ...
        if my_orientation == "이성을 만나고 싶어요":
            if my_gender == "남자" and candidate.my_gender != "여자":
                continue
            if my_gender == "여자" and candidate.my_gender != "남자":
                continue
            if candidate.preferred_gender not in ["이성을 만나고 싶어요", "모두 만나고 싶어요"]:
                continue
        elif my_orientation == "동성을 만나고 싶어요":
            if my_gender != candidate.my_gender:
                continue
            if candidate.preferred_gender not in ["동성을 만나고 싶어요", "모두 만나고 싶어요"]:
                continue
        elif my_orientation == "모두 만나고 싶어요":
            if candidate.preferred_gender not in [
        ...
        if all([
            my_lat, my_lon,
            candidate.current_location_lat, candidate.current_location_lon
        ]):

...
def get_candidates(request):
    ...
    for profile in candidates:
        ...
        # 거리 계산 시 예외 처리 추가 가능
        try:
            if my_lat is not None and my_lon is not None and profile._current_location_lat is not None and profile._current_location_lon is not None:
        ...
        photo_url = candidate_user.photos.first().photo_url if candidate_user.photos.exists() else None

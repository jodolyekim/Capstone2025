...
class ProfileAdmin(admin.ModelAdmin):
    list_display = (
        ...
        'is_verified', 'is_rejected'   # ✅ is_approved → is_verified, 거절이면 is_rejected
    )
    search_fields = ('user__email', '_name')
    list_filter = ('_gender', '_sex_orientation', 'is_verified', 'is_rejected')  # ✅ 동일하게
    list_editable = ('is_verified', 'is_rejected')  # ✅ 승인/거절 직접 수정

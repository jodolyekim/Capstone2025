...
class Interest(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='interests')  # ✅ 충돌 없는 이름
...
class InterestKeywordCategoryMap(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='interest_category_maps')  # ✅ 충돌 방지용 이름
